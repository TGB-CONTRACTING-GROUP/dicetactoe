...
public class MainActivity extends AppCompatActivity {
    ...
    private void showMoreOptions() {
        ...
        String[] gameModes = {"PvP", "Single Player vs. AI", "Multiplayer", "Timed Mode", "Game Hints", "Custom Rules"};
        builder.setItems(gameModes, (dialog, which) -> {
            switch (which) {
                case 0: // PvP
                    showPvPDifficultySelection();
                    break;
                case 1: // Single Player vs. AI
...
//    private boolean isMyTurn = false;
//    private TextView playerXScoreText, playerOScoreText;
//    private String pvpDifficulty = "easy"; // Default PvP difficulty
...
////        updateBoardState();
////        updateDiceDisplay();
////        showToast("Player against Player " + pvpDifficulty + " mode");
////    }
//
//    private void setupComputerGame() {
//        isOnlineMode = false;
